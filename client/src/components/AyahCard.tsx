...
export default function AyahCard({ ayah, onClick, isSelected }: AyahCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Decorative Corner */}
      <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 rounded-tl-xl border-primary/20" />
      <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 rounded-br-xl border-primary/20" />
    </motion.div>
  );
}
