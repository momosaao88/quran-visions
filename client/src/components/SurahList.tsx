              ...
              <div className="space-y-2 p-4">
                {surah.verses.map((verse) => (
                  <button
                    ...
                    className="w-full text-right p-4 rounded-lg bg-card hover:bg-secondary transition-colors border border-transparent hover:border-accent group"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <span className="flex items-center justify-center w-8 h-8 rounded-full bg-primary/10 text-primary text-sm font-bold flex-shrink-0">
                        {verse.number}
                      </span>
                      <p
