# QuranVisions - Project TODO

## Current Task: Add Gharib Al-Quran for All Surahs
...
- [x] Translation toggles (English, Français, Español)
- [x] Save/Share/Bookmark functionality
- [x] Progressive Reading Mode
- [x] Reflection Navigator
- [x] Scroll to top button
- [x] Progress indicator
- [x] Sidebar with Surah list
- [x] Advanced search bar
- [x] SmartCard component with gharib and tafsir sections
